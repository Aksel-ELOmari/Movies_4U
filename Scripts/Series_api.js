    ...
    .then(res => 
        {
            ...
            results.forEach(Movie => {
                ...
                `
                       <a href="${site}id=${Movie.id}&name=${Movie.name}&page=${PG}&URL=discover/tv?language=en-US" target="_blanket"><img title="img" src="https://image.tmdb.org/t/p/original/${Movie.poster_path}" data-id="${Movie.id}"></a>
                        <div class="content">
                            <div class="title">
